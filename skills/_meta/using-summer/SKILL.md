...
2. If not, point them at: `npm install -g summer-engine` then `summer setup <agent> --yes`.
3. If `summer doctor` is available, run it: `summer doctor` reports auth, engine, port, and skill state.
