...
- [ ] Generated GDScript uses typed vars, `@export`, `class_name`, `@onready`, signals (matches `_shared/gd-style.md`).
...
This spec runs via `/skill-test design-mechanic spec` (see `_meta/skill-test/SKILL.md`).
